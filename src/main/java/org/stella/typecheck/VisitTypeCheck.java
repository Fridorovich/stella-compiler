...
{
  private final String ERROR_MISSING_MAIN = "ERROR_MISSING_MAIN";
  public class ProgramVisitor<R,A> implements org.syntax.stella.Absyn.Program.Visitor<R,A>
  {
    ...
    private void checkMainFunctionExists(org.syntax.stella.Absyn.AProgram program) {
      boolean hasMain = false;

      for (org.syntax.stella.Absyn.Decl decl : program.listdecl_) {
    ...
    private boolean isMainFunction(org.syntax.stella.Absyn.Decl decl) {
      if (decl instanceof org.syntax.stella.Absyn.DeclFun) {
        org.syntax.stella.Absyn.DeclFun funDecl = (org.syntax.stella.Absyn.DeclFun) decl;
        return "main".equals(funDecl.stellaident_);
      }

      if (decl instanceof org.syntax.stella.Absyn.DeclFunGeneric) {
        org.syntax.stella.Absyn.DeclFunGeneric funDecl = (org.syntax.stella.Absyn.DeclFunGeneric) decl;
        return "main".equals(funDecl.stellaident_);
      }
